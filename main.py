...
def main():
    ...
    use_best_model = config_data["TEST_USING_BEST_MODEL"]

    # Set if you want to generate images, and the number of images for each class
    generate = config_data["GENERATE"]
    gen_n_images = config_data["N_IMAGES_GENERATED"]

    # Set if you want to start the training with a pre-trained model
    load_mod = config_data["LOAD_MODEL"]
